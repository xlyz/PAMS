...
response.subtitle = T('Postfix virtual users administration made simple!')

## read more at http://dev.w3.org/html5/markup/meta.name.html
response.meta.author = 'xlyz <xlyz@tiscali.it>'
response.meta.description = 'Simple app to administer virtual users in postfix'
response.meta.keywords = 'web2py, python, framework, postfix, admin'
...
response.menu = [
    ...
    (T('Documentation'), False, URL(f='docs'), [
            (T('Setup'), False, URL(f='docs', args=['setup']), [
                (T('Postfix'), False, URL(f='docs', args=['postfix']), []),
                (T('Dovecot'), False, URL(f='docs', args=['dovecot']), []),
            ]),
            (T('Domains'), False, URL(f='docs', args=['domains']), []),
            (T('Mailboxes'), False, URL(f='docs', args=['mailboxes']), []),
            (T('Aliases'), False, URL(f='docs', args=['aliases']), []),
            (T('Administrators'), False, URL(f='docs', args=['admins']), []),
            (T('Roadmap'), False, URL(f='docs', args=['roadmap']), []),
     ]),
    ]
if auth.is_logged_in():
    response.menu.extend([
        (T('Domain'), False, URL(f='domain'), []),
        (T('Domain Alias'), False, URL(f='domain_alias'), []),
        (T('Mailbox'), False, URL(f='mailbox'), []),
        (T('Mail Alias'), False, URL(f='mail_alias'), []),
        (T('Admin'), False, URL(f='admin'), []),
        ])
